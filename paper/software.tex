...
\begin{figure}
\centering
\includegraphics{software_files/figure-latex/software-year-1.pdf}
\caption{\label{fig:software-year}Software counts by year}
\end{figure}

\begin{figure}
\centering
\includegraphics{software_files/figure-latex/model-year-1.pdf}
\caption{\label{fig:model-year}Software counts by year}
\end{figure}
