...
models and estimation methods separately. Subsequent descriptive
analyses will be performed to explore the if there are any intereactions
between software and statistical models used in published research. All
of these analyses will be performed over time to explore trends in
software and statistical model usage and citation rates.
...
model or software keyword by journals.}
\end{figure}
...
\caption{\label{fig:software-year-at1}Primary software counts by year}
\end{figure}

\begin{figure}
\centering
\includegraphics{software_files/figure-latex/spec-software-year-at1-1.pdf}
\caption{\label{fig:spec-software-year-at1}Specialty software counts by
year}
\end{figure}
...
\caption{\label{fig:model-year-at1}Model counts by year}
\end{figure}

\begin{figure}
\centering
\includegraphics{software_files/figure-latex/model-year-latent-1.pdf}
\caption{\label{fig:model-year-latent}Model counts by year}
\end{figure}
