...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/pdf-time-1.pdf}
...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/count-software-1.pdf}
...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/discipline-software-1.pdf}
...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/model-discipline-1.pdf}
...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/software-year-at1-1.pdf}
\caption{\label{fig:software-year-at1}Software percentages by year for education journals}
\end{figure}

\includegraphics{canam_files/figure-latex/software-year-spec-1.pdf}

\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/model-year-at1-1.pdf}
\caption{\label{fig:model-year-at1}Model percentages by year for education journals}
\end{figure}

\includegraphics{canam_files/figure-latex/model-year-other-1.pdf}

\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/software-statmethods-1.pdf}
...
\begin{figure}
\centering
\includegraphics{canam_files/figure-latex/software-statmethods-year-1.pdf}
