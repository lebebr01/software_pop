...
```{r software-year-at1, echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, fig.cap = "Primary software counts by year"}
num_articles <- keywords_nor %>%
...
ggplot(software_keywords, aes(x = year, y = perc_keyword)) + 
    ...
    scale_y_continuous('', breaks = seq(0, 30, 3), limits = c(0, 28), expand = c(0,0)) + 
...
```{r spec-software-year-at1, echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, fig.cap = "Specialty software counts by year"}
software_keywords <- filter(num_articles, group == 'software', 
...
ggplot(software_keywords, aes(x = year, y = perc_keyword)) + 
    ...
    theme_bw() + 
    #geom_text(aes(x = year, y = perc_keyword, label = round(perc_keyword, 0)), size = 5) + 
    scale_y_continuous('', breaks = seq(0, 20, 2), limits = c(0, 20), expand = c(0,0)) + 
    scale_x_continuous("Year", breaks = c(seq(1995, 2018, 5), 2018)) +
    viridis::scale_color_viridis('', discrete = TRUE) + 
    # geom_text(data = filter(software_keywords, year == 1995), 
    #           aes(x = year - 1, y = perc_keyword, label = keyword2))  + 
...
```{r model-year-at1, echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, fig.cap = "Model counts by year"}
...
```{r model-year-latent, echo = FALSE, message = FALSE, warning = FALSE, error = FALSE, fig.cap = "Model counts by year"}
model_keywords <- filter(num_articles, group == 'model', 
...
ggplot(model_keywords, aes(x = year, y = perc_keyword)) + 
    ...
    theme_bw() + 
    #geom_text(aes(x = year, y = perc_keyword, label = round(perc_keyword, 0)), size = 5) + 
    scale_y_continuous('', breaks = seq(0, 20, 2), limits = c(0, 18), expand = c(0,0)) + 
    scale_x_continuous("Year",  breaks = c(seq(1995, 2018, 5), 2018)) +
    viridis::scale_color_viridis('', discrete = TRUE) + 
    # geom_text(data = filter(model_keywords, year == 1995), 
    #           aes(x = year - 1, y = perc_keyword, label = keyword2))  + 
