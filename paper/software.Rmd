...
Commonly used specialty software, such as AMOS, HLM, LISREL, or Mplus, are shown at the bottom of Figure \@ref(fig:software-year-at1). Not suprisingly, the specialty software on average shows up less frequently compared to the general purpose software shown in the top of Figure \@ref(fig:software-year-at1). Out of these four specialty software, AMOS tends to be used the most frequently, LISREL has decreased in usage since 1995, and Mplus has gained additional usage. However, these programs still only account for around 4\% or less of statistical software used. 
